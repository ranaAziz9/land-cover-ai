...
# =========================
st.markdown(
    '<h1 class="main-title">Land Cover AI</h1>',
    unsafe_allow_html=True
)

st.markdown(
    '<p class="subtitle">Satellite Image Classification Platform</p>',
    unsafe_allow_html=True
)
...
def predict_fusion_image(image):
    ...
    pred_class = label_enc.inverse_transform(
        [pred_idx]
    )[0]
